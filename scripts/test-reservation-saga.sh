#!/usr/bin/env bash
# K8s counterpart: scripts/k8s/test-reservation-saga.sh (STR-145). If you
# fix a bug in this script, check whether the same bug exists there too --
# see STR-151, which found fixes made in one copy that were never ported
# to the other.
#
