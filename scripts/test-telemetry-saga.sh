...
# inventory, telemetry, notifications, mailpit, nginx, firebase-emulator all
# healthy).
set -euo pipefail
...
# Found live. Random-suffixed like every other probe/category name in this
# script family so repeat runs don't collide with a previous run's leftover
# row.
